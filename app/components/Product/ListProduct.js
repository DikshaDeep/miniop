...
class ListProduct extends Component {
  ...
  async getList() {
    await this.props.ProductStore.getProductList()
  }
  ...
  onPressProduct = (item, labelname) => {
    console.log('list product click', item)
    ...
    return (
      ...
      >
        <View style={styles.mainView}>
          <View style={styles.imageView}>
            <View style={styles.textView}>
              <Text style={styles.productName}>{index + '.' + item.productName}</Text>
            </View>
          </View>
    ...
    return (
      <View style={styles.itemListViewStyle}>
        <View style={styles.dateViewStyle1}>
          ...
          <View style={{ flex: 0.3, marginRight: 14 }}>
